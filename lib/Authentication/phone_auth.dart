                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          inputFormatters: [
                            FilteringTextInputFormatter.allow(RegExp(r'[+\d]')), // Only + and digits
                          ],
                          validator: (value) {
                  ...
                  : ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          if (countryController.text == '+91' && !isValidIndianNumber(formattedPhoneNumber)) {
                            showAppSnackBar(
                              context,
...
class BubblePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 20; i++) {
      ...
      paint.color = Color(0xFFC67C4E).withOpacity(opacity);
