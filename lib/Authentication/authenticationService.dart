...
//  final currentUserPhoneNumberProvider = StateProvider<String?>((ref) => null);
...
//   AsyncValue<User?> _setupAuthListener() {
...
//               ref.read(currentUserPhoneNumberProvider.notifier).state = userCred.user!.phoneNumber;
//             }
//           } catch (e) {
...
//          // Update phone number provider
//       if (userCredential.user?.phoneNumber != null) {
//         ref.read(currentUserPhoneNumberProvider.notifier).state = userCredential.user!.phoneNumber;
//       }
//       // State will be updated automatically via authStateChanges
...
//     // State will be updated automatically via authStateChanges
//     // Clear phone number provider
//     ref.read(currentUserPhoneNumberProvider.notifier).state = null;
//   }
// }
